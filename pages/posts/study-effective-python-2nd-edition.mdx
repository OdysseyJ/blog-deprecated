...
## 파이썬답게 생각하기
    ...
    ### 여러 iteration에 나란한 루프를 설정하려면 zip을 이용해라
        ...
        주의할 점은, zip은 이터레이션중 더 짧은 개수만큼만 반환하고 종료된다. 둘의 길이가 차이가 날 때, 더 긴 iteration까지 루프를 돌고 싶다면 itertools.zip_longest를 사용한다.
    ...
    ### 대입식을 사용해 반복을 피하라
        ...
        파이썬에서는 switch문을 사용할 수 없지만, 연산자로 훌륭하게 흉내낼 수 있음
        ```
